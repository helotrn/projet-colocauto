...
*/
    public function testSendsEmailToGlobalAdminsZeroCommunity() {
        ...
        $global_admin = factory(User::class)->create(
            [ 'role' => 'admin', ]
        );
        ...
        Mail::assertQueued(
            ...
            function ($mail) use ($global_admin) {
...
*/
    public function testSendsEmailToAdminsOfSameLevel() {
        ...
        Mail::assertQueued(
            BorrowerReviewable::class,
            function ($mail) use ($community_admin) {
        ...
        Mail::assertNotQueued(
            BorrowerReviewable::class,
            function ($mail) use ($parent_community_admin) {
...
*/
    public function testSendsEmailToAdminsMultipleCommunities() {
        ...
        $listener->handle($event);
                             ...
                             // Mail to global admin
        Mail::assertQueued(BorrowerReviewable::class, function ($mail) use ($global_admin) {
            return $mail->hasTo($global_admin->email);
        });
        ...
        Mail::assertQueued(
            BorrowerReviewable::class,
            function ($mail) use ($community_admin, $parent_community_admin) {
                return $mail->hasTo($community_admin->email)
