...
class PolygonCastTest extends TestCase
{
    ...
    public function testSetOnePoint() {
        ...
        $this->assertInstanceOf(\MStaack\LaravelPostgis\Geometries\Polygon::class, $polygon);
    }
    ...
    public function testSetString() {
        ...
        $this->assertEquals('string', $cast->set(null, 'polygon', 'string', []));
    }
    ...
    public function testGetArray() {
        ...
        $this->assertEquals($coordinates, $cast->get(null, 'polygon', $coordinates, []));
    }
    ...
    public function testGetString() {
        ...
        $this->assertEquals('string', $cast->get(null, 'polygon', 'string', []));
    }
}
