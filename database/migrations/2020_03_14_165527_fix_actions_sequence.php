...
class FixActionsSequence extends Migration
{
    public function up() {
        ...
        foreach (['payments', 'takeovers', 'handovers', 'incidents', 'intentions', 'extensions', 'pre_payments'] as $table) {
            \DB::statement("ALTER TABLE $table ALTER COLUMN id SET DEFAULT nextval('actions_id_seq'::regclass)");
        }
    }
