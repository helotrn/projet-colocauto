...
<p
    ...
    "
>
    {{ $caller->name }} a contesté les données entrées lors de la prise de
    possession du véhicule sur son emprunt de votre {{ $loan->loanable->name }}
    qui commençait à {{ $loan->departure_at }}.
</p>
