  ...
  fr: {
    ...
    home: [
      ...
      },
      {
        ...
        content: '<p>LocoMotion n’est pas un service clé en main, c’est un projet citoyen en cours de développement. On le construit ensemble en se concentrant dans certains quartiers avant de l’adapter à d’autres réalités. Pour le moment, LocoMotion est disponible dans Petite-Patrie et Ahuntsic.</p>',
      },
      {
