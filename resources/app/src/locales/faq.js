  ...
  fr: {
    ...
    home: [
      ...
      },
      {
        ...
        content: '<p>Recevez une contribution des personnes qui l’utilisent. La contribution vise à couvrir les frais réels et se base sur la distance parcourue et la durée. Il y a deux catégories d’auto, qui correspondent à des coûts différents.</p><p>Pour le détail des coûts, voir la <a href="http://bit.ly/locomotion-tarification" target="_blank">tarification LocoMotion</a>.</p>',
      },
      {
        title: 'Quel âge faut-il pour participer?',
        content: '<p>Pour les vélos et les remorques à vélo, vous devez avoir 18 ans.</p><p>Pour le partage d’auto, vous devez avoir 21 ans et un permis de conduire québécois.</p>',
      },
      {
        title: 'Ça fonctionne avec les permis de conduire étrangers?',
        content: '<p>Non, malheureusement. Pour conduire une auto en partage avec LocoMotion, vous avez besoin d’un permis québécois.</p>',
      },
      {
        title: 'Pourquoi LocoMotion existe seulement dans certains quartiers?',
        content: '<p>LocoMotion n’est pas un service clé en main, c’est un projet citoyen en cours de développement. On le construit ensemble en se concentrant dans certains quartiers avant de l’adapter à d’autres réalités. Pour le moment, LocoMotion est disponible dans La Petite-Patrie et Ahuntsic.</p>',
      },
      {
    ...
    sections: [
        ...
        questions: [
          {
            ...
            content: '<p>Consultez le document sur la <a href="http://bit.ly/locomotion-tarification" target="_blank">tarification LocoMotion</a>.</p>',
          },
          {
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            content: '<p>Pour le moment, les coûts de fonctionnement de la plateforme ne sont pas facturés aux participant-e-s car nous sommes encore en phase pilote. Nous testons notamment comment couvrir ces frais et la contribution volontaire est la piste que nous explorons pour le moment!</p>',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        questions: [
          {
            title: 'Pourquoi LocoMotion existe seulement dans certains quartiers?',
            content: '<p>LocoMotion n’est pas un service clé en main, c’est un projet citoyen en cours de développement. On le construit ensemble en se concentrant dans certains quartiers avant de l’adapter à d’autres réalités.</p>',
          },
          {
          ...
          },
          {
            ...
            content: '<p>Par défaut, on met à disposition votre auto, votre vélo ou autre véhicule à très petite échelle, à votre voisinage. Ensuite, vous avez le choix. Vous pouvez <a href="/profile/loanables">changer vos préférences de partage</a> pour en faire profiter tout le quartier!</p>',
          },
          {
