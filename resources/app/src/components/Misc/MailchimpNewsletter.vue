      ...
      <div>
        ...
        <div>
          <div>
            ...
            <p>
              Je consens &agrave; recevoir les communications de Solon sur les
              activit&eacute;s de l'organisme par les moyens suivants:
            </p>
            ...
            <p>
              Vous pouvez changer d'avis &agrave; tout moment, en cliquant sur le lien
              "Me d&eacute;sinscrire", pr&eacute;sent dans tous les courriels que vous
              recevrez de notre part.
            </p>
          </div>

          <div>
            <p>
              Nous utilisons Mailchimp pour nos communications. En cliquant pour vous
              abonner, vous reconnaissez que vos informations seront transférées à
              Mailchimp pour traitement.
